...
it('increments value on click', async () => {
  ...
  await fireEvent.click(getByText(/increment/i))
...
<Notes>
  Use tools that help you avoid testing implementation details
  (vue-testing-library).
</Notes>

---

| What             | Type        | mounting  | Service     | API calls | Store       |
| ---------------- | ----------- | --------- | ----------- | --------- | ----------- |
...
Okay Adrià enough said. How to start?
